...
(PS:If you don't use it in `compiler`  directory,make sure to copy `/compiler/Kotoamatsukami.config`  and `/compiler/branch2call_process.py`to your `work directory`)
...
You can set the configuration file in `/tmp/Kotoamatsukami/Kotoamatsukami.config`,which format is as follows.
...
You can find the example of Kotoamatsukami.config in https://github.com/zzzcccyyyggg/Kotoamatsukami/blob/llvm-17-plugins/compiler/Kotoamatsukami.config
